...
import { pathwaysCarouselItems, takenoteCarouselItems } from "../../constants/carouselData";
import { Box } from "@mui/material";

const TakenoteCarousel = () => {
  return (
    <Box
      sx={{
    ...
    >
      ...
      >
        {takenoteCarouselItems.map((item) => (
...
export default TakenoteCarousel;
